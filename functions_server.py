                ...
                for i,object in enumerate(objects):
                    ...
                    if check:
                                ...
                                if (checkcounter[i]-1) % 4 == 0:
                                    ...
                                    object.colour = BLUE
                                    somewhatcertain.append(i)
                                    uncertain.remove(i)

                                elif (checkcounter[i]-3) % 4 == 0:
                                    object.colour = DARKBLUE
                                elif (checkcounter[i]-4) % 4 == 0:
                                    object.colour = WHITE
                                    selectedobj = selectedobj - 1
                                    selobjidx.remove(i)
...
#        print totalperf
    return corrident, mark_rt, totalperf, selectorder, selobjidx, uncertain, somewhatcertain, selcor_objidx, selwrong_objidx, objects
